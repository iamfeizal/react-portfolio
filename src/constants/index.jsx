...
export const EXPERIENCES = [
    {
        ...
        skills: ['Streamlit', 'Spotify Basic Pitch', 'Teamwork'],
        link: 'https://stechoq.com'
    },
    {
        role: 'Project Manager Intern',
        company: 'PT. Stechoq Robotika Indonesia',
        descripction: 'Responsible for coordinating the team and ensuring that we stayed on track with the timeline and goals that had been set using the Agile Scrum development method.',
        year: 'Feb 2024 - Jun 2024',
        skills: ['Leadership', 'Agile Scrum', 'Business Pitch Deck', 'Teamwork'],
        link: 'https://stechoq.com'
    },
    {
        ...
        skills: ['C++', 'Flutter', 'Java', 'Microsoft Project', 'IT Project Management', 'Requirement Engineering', 'Teamwork'],
        link: 'http://upnyk.ac.id/'
    },
    {
        ...
        skills: ['DeepLearning', 'Machine Learning', 'Python'],
    ...
    },
    {
        ...
        skills: ['Data Cleaning', 'Data Analysis', 'Data Visualization', 'Data Driven Decision Making'],
        link: 'https://bdd.kemenparekraf.go.id/'
    },
]
